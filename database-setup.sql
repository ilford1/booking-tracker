-- Influencer Booking Tracker Database Schema
...
((SELECT id FROM creators WHERE handle = '@wanderlust_tina'), (SELECT id FROM campaigns WHERE name = 'Holiday Travel Guide'), 'pending', 2800.00, '{"video", "post"}', '2024-11-15', '2024-11-20', 'Waiting for confirmation');
